  ...
  require(["pub-sub.min", "cookie.min"], function (login_register, cookie) {
    ...
    if (user && pass) {
      $.ajax({
        type: 'get',
        url: "/".concat(act),
        data: "act=".concat(act, "&username=").concat(user, "&password=").concat(pass),
...
$('.site-header').on('mouseenter', '.header-nav-item', function () {
  ...
  $(this).children('.dui-dropdown-menu').css('display', 'block').end().siblings().children('.dui-dropdown-menu').css('display', 'none'); //移出nav列表隐藏所有二级菜单
...
$(document).ready(function () {
  ...
  function smallSlider(productSliderArr) {
    ...
    for (var index in productSliderArr["img"]) {
      imgsP += " <div class=\"swiper-slide\" index=\"".concat(index, "\">\n                        <img src-data=").concat(productSliderArr["img"][index], " src=\"https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=4156711157,3719769417&fm=15&gp=0.jpg\" alt=\"\" class=\"slide-img\">\n                        <div class=\"slide-text\">\n                            <h3 class=\"slide-title\">").concat(productSliderArr["title"][index], "</h3>\n                            <p class=\"slide-desc\">").concat(productSliderArr["desc"][index], "</p>\n                        </div>\n                    </div>");
    }
